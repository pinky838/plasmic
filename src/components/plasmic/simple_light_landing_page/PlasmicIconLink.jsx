...
import * as sty from "./PlasmicIconLink.module.css" // plasmic-import: XxQ1aYjXNaM1Y/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg___3Gngz)}
              role={"img"}
            />
          ),
