...
import * as sty from "./PlasmicTestimonial.module.css" // plasmic-import: b_VYC6giBwB7Zi/css
import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes" // plasmic-import: hRBw2FL6KBeSLZ/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___4OyQb)}
      >
        <div
