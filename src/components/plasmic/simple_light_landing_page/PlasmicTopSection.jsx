...
import * as sty from "./PlasmicTopSection.module.css" // plasmic-import: M42G6rc-gA2gb/css
import heroImageCpNjoTkqT62JLe from "./images/heroImage.png" // plasmic-import: cpNJOTkqT62jLe/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__ktn0N)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__iQsF)}
        >
          <div className={classNames(defaultcss.all, sty.box__umjWn)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__gVw6X)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__c28Yy)}
            text={"Start free trial"}
            type={"solidBlue"}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__jS5Ml)}
            text={"Learn more"}
            type={"solidBlack"}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box___9U76J)}>
          <img
